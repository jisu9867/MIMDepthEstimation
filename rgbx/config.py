...
# C.rgb_root_folder = "/media/jslee/Data2/jslee_two/jisu/VPD/depth/dataset/nyu_depth_v2/sync/"
...
C.gt_root_folder = "/media/jslee/Data2/jslee_two/jisu/MIM-Depth-Estimation/label/train"
C.gt_root_folder_eval = "/media/jslee/Data2/jslee_two/jisu/MIM-Depth-Estimation/label/val/"
C.gt_format = '.png'
...
C.train_source = "/media/jslee/Data2/jslee_two/jisu/MIM-Depth-Estimation/dataset/filenames/eigen_benchmark/train_list.txt"
C.eval_source = "/media/jslee/Data2/jslee_two/jisu/MIM-Depth-Estimation/dataset/filenames/eigen_benchmark/test_list.txt"
C.is_test = False
C.num_train_imgs = 23000
C.num_eval_imgs = 652
C.num_classes = 2
...
C.pretrained_model = "/media/jslee/Data2/jslee_two/jisu/RGBX_Semantic_Segmentation/pretrained_models/mit_b2.pth"
