...
class SegEvaluator(Evaluator):
    ...
    def func_per_iteration(self, data, device):
        ...
        #
        # masks = pred.astype(np.uint8)
        # png = Image.fromarray(masks).convert('P')
        # png.putpalette(palette)
        # png.save(f'./mask/mask_2/maks{self.index}.png')
